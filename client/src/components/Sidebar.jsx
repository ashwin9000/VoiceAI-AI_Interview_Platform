    ...
    <>
      ...
      <div className="px-5 mb-6">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-sm font-bold text-[#191c1e] leading-tight">VoiceAI</h1>
      ...
      <div className="mt-auto border-t border-[#e5e7eb] pt-3 px-4">
        <Link to="/help" className={`sidebar-link ${active === '/help' ? 'active' : ''}`} onClick={() => setMobileOpen(false)}>
    ...
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-[#e5e7eb] px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <img src="/assets/logo.png" alt="VoiceAI" className="w-8 h-8 rounded-lg object-contain" />
          <span className="text-sm font-bold text-[#191c1e]">VoiceAI</span>
        </div>
